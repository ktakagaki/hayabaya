...
public class RunSettings {
    ...
    static final public int ARRAY_SIZE_MAX =  20_000; // hundred thousand
    static final public int ARRAY_SIZE_STEPS =  2_000;
    ...
    static final public int CYCLES_MAX   = 4000; // ten thousand
