...
/**
 * Specific implementation of the Loopers class for the data type Boxed Float
 */
public class LoopersFloatBoxed extends Loopers {
    private static final Logger logger = (Logger) LoggerFactory.getLogger(LoopersFloatBoxed.class);
    ...
    /**
     * Specific implementation of {@link org.hayabaya.loopers.Loopers#operateLoop(Operation)} for the data type Boxed Float
    ...
    /**
     * Specific implementation of {@link org.hayabaya.loopers.Loopers#initializeArrayElements(int)} for the data type Boxed Float
