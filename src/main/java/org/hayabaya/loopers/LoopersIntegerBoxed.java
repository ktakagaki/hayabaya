...
public class LoopersIntegerBoxed extends Loopers {
    private static final Logger logger = (Logger) LoggerFactory.getLogger(LoopersIntegerBoxed.class);
    ...
    /**
     * Specific implementation of {@link org.hayabaya.loopers.Loopers#operateLoop(Operation)} for the data type Boxed Integer
    ...
    void operateLoop(Operation operation) {
        ...
        switch( operation ) {
            ...
            case NOTEQUAL:
                ...
                break;
            default:
                throw new IllegalArgumentException("Invalid operation reached in LoopersInteger");
        }
    }

    /**
     * Specific implementation of {@link org.hayabaya.loopers.Loopers#initializeArrayElements(int)} for the data type Boxed Integer
