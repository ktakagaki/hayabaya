...
/**
 * Specific implementation of the Loopers class for the data type integer
 */
public class LoopersInt extends Loopers {
    private static final Logger logger = (Logger) LoggerFactory.getLogger(LoopersInt.class);
    ...
    /**
     * Specific implementation of {@link org.hayabaya.loopers.Loopers#operateLoop(Operation)} for the data type integer
    ...
    /**
     * Specific implementation of {@link org.hayabaya.loopers.Loopers#initializeArrayElements(int)} for the data type integer
